...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            //first loop through all the animals, if there is an animal with "?" for pet age, then prompt them to add an age. Skip animalID with "" defeault
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 2] == "Age: ?")
                {
                    do
                    {
                        Console.WriteLine($"Please enter a pet age for {ourAnimals[i, 0]}.");
                        readResult = Console.ReadLine();
                ...
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 4] == "Physical description: ")
                {
                    do
                    {
                        ...
                        if (readResult != null)
                        {
                            ...
                            if(animalPhysicalDescription == "" || animalPhysicalDescription == " ")
                            {
                                validEntry = false;
                            }
                            else
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 3] == "Nickname: ")
                {
                    do
                    {
                        ...
                        if(readResult != null)
                        {
                            ...
                            if(animalNickname == "" || animalNickname == " ")
                            {
                                validEntry = false;
                            }
                            else{
                ...
                {
                    do{
                        Console.WriteLine($"Enter a personality description for {ourAnimals[i,0]} (likes or dislies, tricks, energy level)");
                        readResult = Console.ReadLine();

                        if(readResult != null)
                        {
                            animalPersonalityDescription = readResult;
                            if(animalPersonalityDescription == "" || animalPersonalityDescription == " ")
                            {
                                validEntry = false;
                            }
                            else{
